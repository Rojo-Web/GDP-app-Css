<div class="row" style="padding: 0% 5% 5% 5%;justify-content: center;">
    ...
    <div class="col" style="max-width: 30%;">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <div class="form-group mb-2 mb20">
                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" value="{{ old('Contraseña', $user?->password) }}" required autocomplete="new-password">
    ...
    <div style="text-align: center; margin-top: 30px;">
        ...
        <a href="{{ route('users.index')}}" class="btn btn-warning" style="width: 30%;">cancelar</a>
