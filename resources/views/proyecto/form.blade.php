<!-- <div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="estado" class="form-control @error('estado') is-invalid @enderror" value="{{ old('estado', $proyecto?->estado) }}" id="estado" placeholder="Estado">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_inicio" class="form-control @error('fecha_inicio') is-invalid @enderror" value="{{ old('fecha_inicio', $proyecto?->fecha_inicio) }}" id="fecha_inicio" placeholder="Fecha Inicio">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_final" class="form-control @error('fecha_final') is-invalid @enderror" value="{{ old('fecha_final', $proyecto?->fecha_final) }}" id="fecha_final" placeholder="Fecha Final">
            {!! $errors->first('fecha_final', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="lider_id" class="form-label">{{ __('Lider Id') }}</label>
            <input type="text" name="lider_id" class="form-control @error('lider_id') is-invalid @enderror" value="{{ old('lider_id', $proyecto?->lider_id) }}" id="lider_id" placeholder="Lider Id">
            {!! $errors->first('lider_id', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="integrantes" class="form-label">{{ __('Integrantes') }}</label>
            <label for="integrantes">Selecciona integrantes:</label>
            <select id="integrantes" name="integrantes[]" multiple>
...
<div class="row" style="padding: 0% 5% 5% 5%;justify-content: center;">
    ...
    <div class="col" style="max-width: 30%;">
        ...
        <div class="form-group mb-2 mb20">
            <label for="integrantes">Selecciona los integrantes con [ctrol]:</label>
